...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{llX}
    ...
    React        & 18.2.0           & Frontend framework (port 3002 with strictPort). \\
    TypeScript   & 4.9.5            & Frontend and shared types. \\
    Vite         & 4.x              & Frontend build tool; \texttt{strictPort: true} prevents silent port remapping. \\
    Tailwind CSS & 3.x              & Utility-first CSS framework; dark mode via \texttt{class} strategy. \\
    Zustand      & 4.x              & Lightweight frontend state management (auth, settings, editor). \\
    Express.js   & 4.21.2           & Backend HTTP framework (port 5001). \\
    Sequelize    & 6.37.7           & ORM for SQLite. \\
    sqlite3      & 5.1.7            & SQLite native bindings. \\
    Nodemailer   & 6.x              & Email delivery for verification codes and password reset. \\
