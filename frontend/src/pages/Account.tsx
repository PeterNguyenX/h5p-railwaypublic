...
export default function Account() {
  ...
  }, [token, profile?.displayName, profile?.subject, user?.username, user?.email, navigate, isAdmin]);
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
      <div className="mb-8">
        ...
        <p className="text-slate-600 text-[15px]">Update your profile identity shown in the top-right header.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {!isAdmin && (
            <div>
              <label className="block text-[14px] font-semibold text-slate-700 mb-1.5">Teaching Subject</label>
              <input
                type="text"
                value={subject}
